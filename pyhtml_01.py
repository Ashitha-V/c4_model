...
# Class uses Jinja2 library to populate dynamic values to HTML template.
class DSLDashboard:
    ...
    # Updates the Class variable product_table_data list with the Product names and their respective status.
    # Status is obtained from the containers present in failed_containers_dict Dictionary.
    ...
    # Updates the Class variable env_table_data list with the Environment names and their respective status.
    ...
    # Updates the Class variable test_status list with the Containers names Status for each Product.
    # And Class variable failure_msg with the report status message to be hovered.
    ...
    # Passes all the variables and values to HTML template and renders to myfile.html with it's path in console.
